...
head.append("Authorization", "Bearer "+access)
 ...
 await fetch(`https://test.api.amadeus.com/v2/shopping/flight-offers?originLocationCode=${originiata}&destinationLocationCode=${desinationiata}&departureDate=${departuredate}&returnDate=${returndate}&adults=${adultsnum}`, parames)
  .then(response => response.json())
...
console.log ( await logic(document.querySelectorAll('#od')[0],document.querySelectorAll('#od')[1],d3,d4,d5))
